		...
		if (mysqli_connect_errno()) {
			echo '<h3>Database Access Error!</h3>';
			   ...
			   if(isset($_POST['software'])){
				...
				$software 			= isset($_POST['sotware']) ? $_POST['software'] : '';
				...
				$select = "INSERT INTO `CapstoneDB`.`Software` (`Software Name`, `Software Asset Number`, `Date Purchased`, `Date Downloaded`, `License`, `Expiration_Date`) 
